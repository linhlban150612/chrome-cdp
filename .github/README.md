# <img src="chrome-logo.png" alt="Google Chrome logo" width="32" height="32" valign="middle" align="absmiddle"> chrome-cdp

## Install

```bash
npx skills add megait004/chrome-cdp --skill chrome-cdp
```
...
- **Inspect the real browser** — DOM, storage, listeners, requests, responses.
